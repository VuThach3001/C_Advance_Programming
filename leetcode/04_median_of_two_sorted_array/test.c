...
void printTestResult (struct TestResult result)
{
    ...
    printf ("        Expected: %.6f, Got: %.6f [%s]\n",
           result.expected, result.actual, result.passed ? "PASS" : "FAIL");
    printf ("\n");
}
...
int main ()
{
    ...
    // ====================
    {
        int arr1[] = { 1, 3 };
        int arr2[] = { 2 };
        results[numTests++] = runTest (1, "Example 1: [1,3] and [2], median = 2.0",
                                      arr1, 2, arr2, 1, 2.0);
    }
    ...
    // ====================
    {
        int arr1[] = { 0, 0 };
        int arr2[] = { 0, 0 };
        results[numTests++] = runTest (2, "Example 2: [0,0] and [0,0], median = 0.0",
                                      arr1, 2, arr2, 2, 0.0);
    }
    ...
    // ====================
    {
        int arr1[] = {};
        int arr2[] = { 1 };
        results[numTests++] = runTest (3, "Edge case: Empty array []. Single element [1], median = 1.0",
                                      arr1, 0, arr2, 1, 1.0);
    }
    ...
    // ====================
    {
        int arr1[] = { 2 };
        int arr2[] = {};
        results[numTests++] = runTest (4, "Edge case: Single element [2], Empty array [], median = 2.0",
                                      arr1, 1, arr2, 0, 2.0);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 2 };
        int arr2[] = { 3, 4, 5 };
        results[numTests++] = runTest (5, "Case 5: [1,2] and [3,4,5], median = 3.0",
                                      arr1, 2, arr2, 3, 3.0);
    }
    ...
    // ====================
    {
        int arr1[] = { -5, -3, -1 };
        int arr2[] = { -4, -2, 0 };
        results[numTests++] = runTest (6, "Case 6: [-5,-3,-1] and [-4,-2,0], median = -2.5",
                                      arr1, 3, arr2, 3, -2.5);
    }
    ...
    // ====================
    {
        int arr1[] = { -2, 0, 2 };
        int arr2[] = { -1, 1, 3 };
        results[numTests++] = runTest (7, "Case 7: [-2,0,2] and [-1,1,3], median = 0.5",
                                      arr1, 3, arr2, 3, 0.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 1000000 };
        int arr2[] = { 1000000 };
        results[numTests++] = runTest (8, "Case 8: [1000000] and [1000000], median = 1000000.0",
    ...
    // ====================
    {
        int arr1[] = { 1, 2, 3, 4 };
        int arr2[] = { 10, 20 };
        results[numTests++] = runTest (9, "Case 9: [1,2,3,4] and [10,20], median = 3.5",
                                      arr1, 4, arr2, 2, 3.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 2 };
        int arr2[] = { 3, 4, 5, 6 };
        results[numTests++] = runTest (10, "Case 10: [1,2] and [3,4,5,6], median = 3.5",
                                       arr1, 2, arr2, 4, 3.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 5, 5, 5 };
        int arr2[] = { 5, 5 };
        results[numTests++] = runTest (11, "Case 11: [5,5,5] and [5,5], median = 5.0",
                                      arr1, 3, arr2, 2, 5.0);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 2, 3 };
        int arr2[] = { 4, 5, 6 };
        results[numTests++] = runTest (12, "Case 12: [1,2,3] and [4,5,6], median = 3.5",
                                      arr1, 3, arr2, 3, 3.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 3, 5 };
        int arr2[] = { 2, 4, 6 };
        results[numTests++] = runTest (13, "Case 13: [1,3,5] and [2,4,6], median = 3.5",
                                      arr1, 3, arr2, 3, 3.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 2, 3, 4, 5 };
        int arr2[] = { 6 };
        results[numTests++] = runTest (14, "Case 14: [1,2,3,4,5] and [6], median = 3.5",
                                      arr1, 5, arr2, 1, 3.5);
    }
    ...
    // ====================
    {
        ...
        results[numTests++] = runTest (16, "Case 16: [-100,-50,0] and [-75,-25,25,50], median = -25.0",
                                      arr1, 3, arr2, 4, -25.0);
    }
    ...
    // ====================
    {
        ...
        int arr2[] = { 10 };
        results[numTests++] = runTest (17, "Case 17: [1..9] and [10], median = 5.5",
                                      arr1, 9, arr2, 1, 5.5);
    }
    ...
    // ====================
    {
        int arr1[] = { 1, 1, 1 };
        int arr2[] = { 1, 1, 1 };
        results[numTests++] = runTest (19, "Case 19: [1,1,1] and [1,1,1], median = 1.0",
                                      arr1, 3, arr2, 3, 1.0);
    }
    ...
    // ====================
    {
        int arr1[] = { 2, 4 };
        int arr2[] = { 1, 3 };
        results[numTests++] = runTest (20, "Case 20: [2,4] and [1,3], median = 2.5",
                                      arr1, 2, arr2, 2, 2.5);
    }
